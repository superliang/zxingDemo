...
final class CameraConfigManager {
	...
	private static final String TAG = CameraConfigManager.class.getName();
	...
	/**
	 * FIXME: This is a hack to turn the flash off on the Samsung Galaxy. And
	 * this is a hack-hack to work around a different value on the Behold II
	 * Restrict Behold II check to Cupcake, per Samsung's advice if
	 * (Build.MODEL.contains("Behold II") && CameraManager.SDK_INT ==
	 * Build.VERSION_CODES.CUPCAKE)
	 */
	private void setFlash(Camera.Parameters parameters) {
		if (Build.MODEL.contains("Behold II")
				&& CameraManager.SDK_INT == Build.VERSION_CODES.CUPCAKE) { // 3 = Cupcake
